function codeEditor(){
  ...
  w.open();
  w.write('<!DOCTYPE html><html><head><meta charset="utf-8"/><base href="https://wbpid.github.io/"/><style>'+ t.eq(1).val() +'</style></head><body>'+ t.eq(0).val() +'<script>'+ t.eq(2).val() +'</script></body></html>');
  w.close();
}
